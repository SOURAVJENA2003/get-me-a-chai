    ...
    <div className='container mx-auto my-10 px-4 sm:px-6'  >
      ...
      <form className="mx-auto w-full max-w-xl" action={handleSubmit}  >
        ...
        <div className="my-2">
          ...
          <input value={form?.email || ""} readOnly type="email" name='email' id="email" className="block w-full cursor-not-allowed p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-100 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
        </div>
        {/* input forusername */}
        <div className='my-2'>
